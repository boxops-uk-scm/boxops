...
func builtins(pkg *Package) starlark.StringDict {
	builtins := starlark.StringDict{
		"action": starlark.NewBuiltin("action", ActionBuiltin(pkg.Builder)),
		"file":   starlark.NewBuiltin("file", FileBuiltin(pkg.Builder)),
		"dir":    starlark.NewBuiltin("dir", DirBuiltin(pkg.Builder)),
		"policy": starlark.NewBuiltin("policy", PolicyBuiltin(pkg.Builder)),
		"workflow": starlark.NewBuiltin("workflow", WorkflowBuiltin(pkg.Path, pkg.Builder, func(wf Workflow) {
