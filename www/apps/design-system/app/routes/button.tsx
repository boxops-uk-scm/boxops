...
export default function ButtonRoute() {
  return (
    <main {...stylex.props(styles.main)}>
      ...
      <section {...stylex.props(styles.section)}>
        <Button startContent={(iconProps) => <Icon.PencilSimple {...iconProps} />} label="Button" variant="default" />
        <Button startContent={(iconProps) => <Icon.PencilSimple {...iconProps} />} label="Button" variant="flat" />
        <Button startContent={(iconProps) => <Icon.PencilSimple {...iconProps} />} label="Button" variant="primary" />
        <Button startContent={(iconProps) => <Icon.PencilSimple {...iconProps} />} label="Button" variant="negative" />
        <Button startContent={(iconProps) => <Icon.PencilSimple {...iconProps} />} label="Button" variant="positive" />
      </section>
      <section {...stylex.props(styles.section)}>
        ...
        <Button compact startContent={(iconProps) => <Icon.Copy {...iconProps} />} label="Button" variant="primary" />
        <Button compact startContent={(iconProps) => <Icon.Copy {...iconProps} />} label="Button" variant="negative" />
        <Button compact startContent={(iconProps) => <Icon.Copy {...iconProps} />} label="Button" variant="positive" />
      </section>
      <section {...stylex.props(styles.section)}>
        ...
        <Button endContent={(iconProps) => <Icon.PencilSimple {...iconProps} />} label="Button" variant="negative" />
        <Button endContent={(iconProps) => <Icon.PencilSimple {...iconProps} />} label="Button" variant="positive" />
      </section>
      <section {...stylex.props(styles.section)}>
