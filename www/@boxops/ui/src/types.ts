...
export type RenderFunction<S> = React.ReactNode | ((state: S) => React.ReactNode);

export function useRenderFunction<S>(renderProp: RenderFunction<S>, state: S): React.ReactNode {
